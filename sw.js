...
var EXTRA = ["/about", "/article-color-design", "/article-cron-server", "/article-radix-kihonjoho", "/article-regex-learning", "/privacy", "/terms", "/tool-color", "/tool-cron", "/tool-jwt", "/tool-radix", "/tool-regex", "/tool-unixtime"];
